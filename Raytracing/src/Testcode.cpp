...
//    frameCounter = 0;
//    // 调整旋转
//    rotatAngle += 150 * (x - lastX) / 1024;
//    upAngle += 150 * (y - lastY) / 1024;
...
//}
//
//void KeyboardDown(int button, int state, int x, int y) 
//{
//    if (button == GLUT_LEFT_BUTTON && state == GLUT_DOWN) 
//    {
//        lastX = x, lastY = y;
...
//    //Import("Stanford Bunny.obj", triangles, m, true);
//    readObj("Stanford Bunny.obj", triangles, m, getTransformMatrix(vec3(0, 0, 0), vec3(0.3, -1.6, 0), vec3(1.5, 1.5, 1.5)), true);
//
...
//    // 管线配置
//
//    pass1.program = getShaderProgram("./content/shader/pass1FS.glsl", "./content/shader/pass1VS.glsl");
...
//    glUseProgram(0);
//
//    pass2.program = getShaderProgram("pass2.fsh", "./content/shader/pass1VS.glsl");
//    lastFrame = getTextureRGB32F(pass2.width, pass2.height);
//    pass2.colorAttachments.push_back(lastFrame);
//    pass2.bindData();
//
//    pass3.program = getShaderProgram("pass3.fsh", "./content/shader/pass1VS.glsl");
//    pass3.bindData(true);
//
//
//    // ----------------------------------------------------------------------------- //
...
//    glClearColor(0.2f, 0.3f, 0.3f, 1.0f);   // 背景颜色 -- 黑
//
